...
overall_df <- final_data %>% filter(state %in% overall_states)
mmr_df <- final_data %>% filter(state %in% mmr_states)
write.csv(overall_df, "overall_df.csv", row.names = FALSE)
write.csv(mmr_df, "mmr_df.csv", row.names = FALSE)
s```
