...
overall <- overall %>% left_join(data.frame(state = unique(MMR$state), 
                                            stateID = 1:nStates))
...
MuMIn::model.sel(unadj_overall_ex, unadj_overall_ind, 
                 unadj_overall_ar1, rank="QIC")

# 4. Overall with adjusted 
# Exchangeable
